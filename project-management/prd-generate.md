...
- First argument: Path to the main design document (required)
- Additional arguments: Paths to reference files for additional context (optional)

Example: `/user:generate-prd project-design.md docs/api-spec.md docs/ui-mockups.md`
...
4.  **Save PRD:** Save the generated document as `project-prd.md` inside the `/tasks` directory.
